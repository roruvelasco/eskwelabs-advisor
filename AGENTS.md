...
| `conversations`       | controller, service, repository, serializer, schema, access-policy, use-cases, dto, tests (+ conversation-shares service/repository/serializer/schema for public share links) | ConversationController, ConversationsService, ConversationsRepository, ConversationSharesService, ConversationSharesRepository                                       |
...
| `share/:shareId` | share/[shareId]/page.tsx (public, no auth) | SharedConversationView (read-only)                       | domains/conversations/{api,queries}.ts |
