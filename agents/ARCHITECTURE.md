...
- `EMBEDDING_PROVIDER` (`GroqEmbeddingProvider` using `nomic-embed-text-v1.5`, 768d) generates dense vectors for semantic retrieval. Embedding failures fail closed (empty context, no fallback to token-matching).
