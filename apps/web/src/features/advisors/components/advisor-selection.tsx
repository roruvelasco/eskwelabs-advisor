...
function AdvisorCard({ id, name, description, index }: AdvisorCardProps) {
  ...
  return (
    <div
      tabIndex={0}
      className="border-border/50 bg-card group flex flex-col rounded-2xl border p-8 transition-colors duration-200 focus-within:border-[#1a4a35] hover:border-[#1a4a35] focus:border-[#1a4a35] focus:outline-none"
    >
      {/* Ordinal */}
      <p className="text-muted-foreground/20 select-none font-serif text-6xl font-medium leading-none transition-colors duration-300 group-focus-within:text-[#2d6a4f]/35 group-hover:text-[#2d6a4f]/35 group-focus:text-[#2d6a4f]/35">
      ...
      <div className="flex h-32 items-center justify-center">
        <Icon
          className="text-muted-foreground/20 transition-colors duration-300 group-focus-within:text-[#2d6a4f]/40 group-hover:text-[#2d6a4f]/40 group-focus:text-[#2d6a4f]/40"
          size={52}
          strokeWidth={1.1}
        />
      </div>
