...
export function HeroSection({
  ...
  const pill0O = useTransform(scrollYProgress, [0.3, 0.4], [0, 1]);
  const pill0Y = useTransform(
    scrollYProgress,
    [0.3, 0.4],
    rm ? [0, 0] : [12, 0]
  );
  ...
  const pill2O = useTransform(scrollYProgress, [0.4, 0.49], [0, 1]);
      ...
      >
        <div className="flex min-h-[100svh] flex-col justify-between overflow-hidden px-6 py-10 md:px-16 md:py-14">
          ...
          */}
            ...
            >
              Three AI specialists designed to help you structure data, align
              stakeholders, and turn analysis into action.
            </motion.p>
          ...
          >
            <motion.div
              ...
              style={{
                background: `linear-gradient(to bottom, ${t.accentFg}70, transparent)`
              }}
            />
            <span
              className="font-sans text-xs uppercase tracking-widest"
