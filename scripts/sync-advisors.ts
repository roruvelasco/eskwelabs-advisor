...
try {
  await sql.begin(async (tx) => {
    await tx`
      INSERT INTO advisors (id, name, description, prompt_doc_id, is_active, status)
      VALUES
        (${advisorRegistry[0].id}, ${advisorRegistry[0].name}, ${advisorRegistry[0].description}, ${advisorRegistry[0].promptDocId}, true, 'active'),
        (${advisorRegistry[1].id}, ${advisorRegistry[1].name}, ${advisorRegistry[1].description}, ${advisorRegistry[1].promptDocId}, true, 'active'),
        (${advisorRegistry[2].id}, ${advisorRegistry[2].name}, ${advisorRegistry[2].description}, ${advisorRegistry[2].promptDocId}, true, 'active')
